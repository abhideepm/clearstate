...
class RecoveryMilestones {
  ...
  static const List<RecoveryMilestone> alcoholMilestones = [
    RecoveryMilestone(
      ...
      description:
          'Your body begins processing alcohol. Blood alcohol levels start dropping.',
    ...
    RecoveryMilestone(
      ...
      description:
          'Blood sugar stabilizes. Anxiety may peak as your body adjusts.',
    ...
    RecoveryMilestone(
      ...
      description:
          'The most dangerous withdrawal period is ending. Your body begins healing.',
    ...
    RecoveryMilestone(
      ...
      description:
          'REM sleep normalizes. You may feel more rested and mentally clear.',
    ...
    RecoveryMilestone(
      ...
      description:
          'Anxiety and depression decrease. Stomach lining begins to heal.',
    ...
    RecoveryMilestone(
      ...
      description:
          'Liver fat can reduce by up to 15%. Blood pressure normalizing.',
    ...
    RecoveryMilestone(
      ...
      description:
          'Risk of heart disease, stroke, and many cancers significantly reduced.',
  ...
  static const List<RecoveryMilestone> nicotineMilestones = [
    RecoveryMilestone(
      ...
      description:
          'Within 20 mins heart rate drops. Within 12 hours CO levels normalize.',
    ...
    RecoveryMilestone(
      ...
      description:
          'Heart attack risk begins to decrease. Nicotine leaves bloodstream.',
    ...
    RecoveryMilestone(
      ...
      description:
          'Nicotine fully eliminated. Breathing becomes easier. Cravings peak.',
    ...
    RecoveryMilestone(
      ...
      description:
          'Blood circulation dramatically improves. Walking becomes easier.',
    ...
    RecoveryMilestone(
      ...
      description:
          'Lung cilia begin regrowing. Coughing and shortness of breath decrease.',
    ...
    RecoveryMilestone(
      ...
      description:
          'Lung function increases up to 30%. Energy levels significantly higher.',
  ...
  static const List<RecoveryMilestone> pornMilestones = [
    RecoveryMilestone(
      ...
      description:
          'Your brain starts reducing dopamine tolerance from artificial stimulation.',
    ...
    RecoveryMilestone(
      ...
      description:
          'Testosterone peaks around day 7. Energy and motivation may increase.',
    ...
    RecoveryMilestone(
      ...
      description:
          'Dopamine receptors begin upregulating. Pleasure from everyday activities increases.',
    ...
    RecoveryMilestone(
      ...
      description:
          'Brain fog lifts. Focus and concentration improve significantly.',
    ...
    RecoveryMilestone(
      ...
      description:
          'Social anxiety decreases. Eye contact and confidence improve.',
    ...
    RecoveryMilestone(
      ...
      status: 'Full Reboot',
      description:
          'Major neural rewiring complete. Significant improvements in all areas.',
    ...
    RecoveryMilestone(
      ...
      status: 'New Normal',
      description:
          'Healthy reward pathways established. Natural attraction restored.',
  ...
  static const List<RecoveryMilestone> caffeineMilestones = [
    RecoveryMilestone(
      ...
      description:
          'Headaches may begin within 12-24 hours as caffeine leaves your system.',
    ...
    RecoveryMilestone(
      ...
      description:
          'Headaches peak. Fatigue and irritability are strongest now.',
    ...
    RecoveryMilestone(
      ...
      description:
          'Physical withdrawal symptoms significantly reduced. Sleep improving.',
    ...
    RecoveryMilestone(
      ...
      description:
          'Energy levels stabilize without caffeine. No more afternoon crashes.',
    ...
    RecoveryMilestone(
      ...
      description:
          'Adrenal glands recovered. Stable energy throughout the day.',
  ...
  static const List<RecoveryMilestone> weedMilestones = [
    RecoveryMilestone(
      ...
      description:
          'THC begins leaving fat cells. Sleep disturbances may occur.',
    ...
    RecoveryMilestone(
      ...
      status: 'REM Rebound',
      description:
          'Vivid dreams return as REM sleep rebounds. Sleep may be restless.',
    ...
    RecoveryMilestone(
      ...
      description:
          'THC largely cleared from body. Cognitive function restored.',
